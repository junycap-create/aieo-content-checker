...
const MessageHouseCTA: React.FC = () => {
  return (
    <div className="bg-[#1a4031] rounded-xl p-6 sm:p-8 md:p-12 text-center md:text-left flex flex-col md:flex-row items-center justify-between gap-8 sm:gap-10 shadow-lg relative overflow-hidden group border border-[#2f5d48] animate-fade-in-up">
      ...
      <div className="relative z-10 max-w-2xl">
        <div className="inline-flex items-center gap-2 bg-[#2f5d48] text-green-50 text-[10px] sm:text-xs font-mono px-3 py-1 rounded-full mb-4 sm:mb-6 uppercase tracking-wider border border-[#4a846a]">
           <ICONS.Zap className="w-3 h-3 text-orange-400" />
           Strategic Partner
        </div>
        <h3 className="text-2xl sm:text-3xl md:text-4xl font-black text-white mb-4 sm:mb-6 leading-tight font-mono tracking-tight">
          AI 시대, 조직의 메시지를<br/>
        ...
        <p className="text-green-100/90 text-sm sm:text-lg md:text-xl leading-relaxed font-light">
      ...
      <div className="relative z-10 shrink-0 w-full sm:w-auto">
        <a 
          ...
          className="inline-flex items-center justify-center gap-3 bg-orange-500 text-white px-8 sm:px-10 py-4 sm:py-5 rounded-lg font-bold font-mono text-base sm:text-lg md:text-xl hover:bg-orange-600 transition-all shadow-lg hover:shadow-orange-500/20 hover:-translate-y-1 active:scale-95 active:translate-y-0 w-full sm:w-auto"
        >
          문의하기
          <ICONS.ArrowRight className="w-5 h-5 sm:w-6 sm:h-6" />
        </a>
      </div>
    </div>
  );
